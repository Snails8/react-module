  ...
  return (
    <div className={styles.container}>
      <Link to="/training" className={styles.link}>
        <div className={ styles.link_container } style={currentPath === '/training' ? {backgroundColor: activeColor} : {}}>
          <div className={ styles.label} >training</div>
        </div>
      </Link>
      <Link to="/fishes" className={styles.link}>
        <div className={ styles.link_container } style={currentPath === '/fishes' ? {backgroundColor: activeColor} : {}}>
          <div className={ styles.label} >fishes</div>
        </div>
      </Link>
      <Link to="/atoms" className={styles.link}>
        <div className={ styles.link_container } style={currentPath === '/atoms' ? {backgroundColor: activeColor} : {}}>
          <div className={ styles.label} >atoms 検証</div>
        </div>
      </Link>
      <Link to="/users" className={styles.link}>
        <div className={ styles.link_container } style={currentPath === '/users' ? {backgroundColor: activeColor} : {}}>
          <div className={ styles.label} >ユーザー管理</div>
        </div>
      </Link>
      <Link to="/inspects" className={styles.link} style={currentPath === '/inspects' ? {backgroundColor: activeColor} : {}}>
      ...
      { clickStatePage &&
        <div>
          <Link to="/memo" className={styles.link}>
            <div className={ styles.link_container } style={currentPath === '/memo' ? {backgroundColor: activeColor} : {}}>
          ...
          <Link to="/useMemo" className={styles.link}>
            <div className={ styles.link_container } style={currentPath === '/useMemo' ? {backgroundColor: activeColor} : {}}>
              <div className={styles.link_container}>
          ...
          <Link to="/useCallBack" className={styles.link}>
            <div className={ styles.link_container } style={currentPath === '/useCallBack' ? {backgroundColor: activeColor} : {}}>
              <div className={styles.link_container}>
          ...
          <Link to="/states" className={styles.link}>
            <div className={ styles.link_container } style={currentPath === '/states' ? {backgroundColor: activeColor} : {}}>
              <div className={styles.link_container}>
      ...
      { clickSamplePage && 
        <div>
          <Link to="/form" className={styles.link}>
            <div className={ styles.link_container } style={currentPath === '/form' ? {backgroundColor: activeColor} : {}}>
              <div className={styles.link_container}>
          ...
          <Link to="/parent-tab" className={styles.link}>
            <div className={ styles.link_container } style={currentPath === '/parent-tab' ? {backgroundColor: activeColor} : {}}>
              <div className={styles.link_container}>
          ...
          <Link to="/download-file" className={styles.link}>
            <div className={ styles.link_container } style={currentPath === '//download-file' ? {backgroundColor: activeColor} : {}}>
              <div className={styles.link_container}>
